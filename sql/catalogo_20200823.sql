...
-- Dumping structure for table catalogo.alumno
...
-- Dumping structure for table catalogo.categoria
...
-- Dumping structure for table catalogo.contacto
...
-- Dumping structure for table catalogo.cotizacion
CREATE TABLE IF NOT EXISTS `cotizacion` (
  ...
  CONSTRAINT `FK_cotizacion_contacto` FOREIGN KEY (`SOLIP_Codigo`) REFERENCES `contacto` (`id`),
...
-- Dumping structure for table catalogo.cotizacion_capacitacion
...
-- Dumping structure for table catalogo.cotizacion_detalle
...
-- Dumping structure for table catalogo.curso
...
-- Dumping structure for table catalogo.descuentos
...
-- Dumping structure for table catalogo.failed_jobs
...
-- Dumping structure for table catalogo.horario_cursos
CREATE TABLE IF NOT EXISTS `horario_cursos` (
  ...
  `hora_inicial` int(11) DEFAULT NULL,
...
-- Dumping structure for table catalogo.horario_instructors
...
-- Dumping structure for table catalogo.instructor
...
-- Dumping structure for table catalogo.menu
...
-- Dumping structure for table catalogo.migrations
...
-- Dumping structure for table catalogo.password_resets
...
-- Dumping structure for table catalogo.permiso
...
-- Dumping structure for table catalogo.persona
...
-- Dumping structure for table catalogo.rol
...
-- Dumping structure for table catalogo.roles
...
-- Dumping structure for table catalogo.role_user
...
-- Dumping structure for table catalogo.solicitante
...
-- Dumping structure for table catalogo.tipocotizacion
...
-- Dumping structure for table catalogo.tiposolicitante
...
-- Dumping structure for table catalogo.ubigeo
...
-- Dumping structure for table catalogo.users
...
-- Dumping structure for table catalogo.usuario
