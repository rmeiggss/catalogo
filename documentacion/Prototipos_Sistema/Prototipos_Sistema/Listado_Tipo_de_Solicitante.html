...
<body>
<div class="container">
<h1>Listado de Tipos de Solicitante</h1>
...
<table class="table table-bordered">
	<tr>
		...
		<th class="text-center">Tipo de Solicitante</th>
		<th class="text-center">Acciones</th>
	</tr>
	<tr>
		<td class="text-center">1</td>
		<td class="text-center">Personal Natural</th>
	...
	<tr>
		...
		<td class="text-center">Personal Juridica</th>
		<td class="text-center">
			<a class="btn btn-warning btn-sm" href="">Editar</a>
			<a class="btn btn-danger btn-sm" href="">Eliminar</a>
		</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<!-- formulario -->
		<div class="container">
		<h1 style="text-align: center">Agregar Tipo de Solicitante</h1>
		<hr>
		<form class="form-horizontal form-control" style="width:400px;height:190px;margin:0 auto">
		Nombre del Tipo de Solicitante:
		<br>
		<br>
		<input class="form-control" type="text" id="primero" name="" />
		<br>
