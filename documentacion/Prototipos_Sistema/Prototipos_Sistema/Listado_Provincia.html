...
<head>
    ...
    $('#mimodallibro').on('shown.bs.modal', function() {
      $('#primero').focus();
    })
  	});
	});
...
<hr>
<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#mimodallibro" id="boton_modal">
Nueva Provincia
</button>
<br>
<br>
...
<!-- Modal -->
<div class="modal fade" id="mimodallibro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<!-- formulario -->
		<div class="container">
		<h1 style="text-align: center">Agregar Provincia</h1>
		<hr>
		...
		<select class="form-control">
  			...
  			<option value="saab">Cajamarca</option>
		</select> 
		<br>
