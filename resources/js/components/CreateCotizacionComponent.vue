        ...
        <div class="row invoice-info">
          ...
          <table class="table table-striped">
              ...
              <tr class="text-center">
                ...
                <tbody>
                    <tr class="text-center" v-for="(cotdetalle, index) in cotizaciondetalle" :key="cotdetalle.CODEP_Codigo">
                      <td>
                      ...
                      <td><input type="text" class="form-control-sm w-100" name="nombre[]" v-model="cotdetalle.CODEC_NombreEquipo" autocomplete="off"></td>
                      ...
                      <td><input type="number" class="form-control-sm w-100" name="cantidad[]" v-model.number="cotdetalle.CODEC_Cantidad" autocomplete="off"></td>
                      <td><input type="number" class="form-control-sm w-100" name="unitario[]" v-model.number="cotdetalle.CODEC_PrecioUnitario" autocomplete="off"></td>
    ...
    export default {
        ...
        computed:{
          setSubTotal:function(){
            var suma = 0;
            return this.cotizaciondetalle.reduce((suma,cotdetalle)=>suma+(cotdetalle.CODEC_PrecioUnitario*cotdetalle.CODEC_Cantidad),0).toFixed(2);
          },
          setIgv:function(){
