    ...
    <form ref="form">
      ...
      <div class="form-group">
        ...
        <select v-model="solicitante.TIPSOLIP_Codigo" class="form-control" name="TIPSOLIP_Codigo" ref="TIPSOLIP_Codigo" id="TIPSOLIP_Codigo" >
            ...
            <option v-for="tipoSolicitante in tiposSolicitante" v-bind:value="tipoSolicitante.TIPSOLIP_Codigo" v-bind:key="tipoSolicitante.TIPSOLIP_Codigo" :disabled='isDisabled'>{{ tipoSolicitante.TIPSOLIC_Descripcion }}</option>
        </select>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select v-model="ubigeo.UBIGC_CodDpto" class="form-control" id="UBIGC_CodDpto" name="UBIGC_CodDpto" ref="UBIGC_CodDpto" @change="listarProvincias()" :disabled='isDisabled'>
        ...
        <div class="form-group">
            ...
            <select v-model="ubigeo.UBIGC_CodProv" class="form-control" id="UBIGC_CodProv" name="UBIGC_CodProv" ref="UBIGC_CodProv" @change="listarDistritos()" :disabled='isDisabled'>
        ...
        <div class="form-group">
            ...
            <select v-model="ubigeo.UBIGC_CodDist" class="form-control" id="UBIGC_CodDist" name="UBIGC_CodDist" ref="UBIGC_CodDist" :disabled='isDisabled'>
        ...
        <button type="button" class="btn btn-info" id="btn-registrar-cotizacion-ensayo" @click="addSolicitante()" :disabled='isDisabled'>
...
export default {
    ...
    created() {
        ...
        this.getSolicitante(this.codigo);
    },
    methods:{
        getSolicitante(id) {
            var url = '/solicitante/' + id + '/get';

            axios.get(url).then(response => {
                let resultado = response.data;
                this.solicitante = resultado;

                var url_provincia = '/provincia/' + resultado.UBIGC_CodDpto + '/list';

                axios.get(url_provincia).then(response => {
                    this.provincias = response.data;

                    var url_distrito = '/distrito/' + resultado.UBIGC_CodDpto + '/' + resultado.UBIGC_CodProv + '/list';
                    axios.get(url_distrito).then(response => {

                        this.distritos = response.data;

                        this.ubigeo.UBIGC_CodDpto = resultado.UBIGC_CodDpto;
                        this.ubigeo.UBIGC_CodProv = resultado.UBIGC_CodProv;
                        this.ubigeo.UBIGC_CodDist = resultado.UBIGC_CodDist;
                ...
                this.mostrarMensajeConfirmacion('¿Desea continuar con el registro?', 'Si', 'No')
                    ...
                    if(result.isConfirmed){
                        axios.put(url, {
                            ...
                            id: this.solicitante.SOLIP_Codigo
                        }).then((response) => {
                            Swal.fire({
                                title: '"' + response.data + '"',
                                icon: 'success',
