...
@endif -->
    <div class="grid-hor">
        ...
        <div class="form-group col-md-6">
            {!! Form::label('apertura', 'Nombre de la Apertura') !!}
            {!! Form::text('apertura',null, ['class' => 'form-control','placeholder'=>'Ingrese el nombre','id'=>'apertura']) !!}
            @error('apertura')
            <small class="text-danger">Escribir el nombre de la apertura</small>
            @enderror
        </div>
        <div class="form-group col-md-6">
