    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 col-md-6 sm-margin-15px-bottom" data-wow-delay="0.2s">
                        <img src="images/primero/imagen1.jpg" alt="" style="margin-top: 40%;width: 100%;" />
                    </div>
                    <div class="col-12 col-lg-4 col-md-6 wow fadeIn" data-wow-delay="0.4s">
                        <img src="images/primero/imagen2.jpg" alt="" style="    width: 100%;margin-top: 50%;" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="p-0 wow fadeIn bg-light-gray" style="background-color: rgb(241, 255, 204);">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-6 cover-background md-height-500px sm-height-350px wow fadeInLeft" style="background-image:url('images/primero/imagen3.jpg');margin: 3rem 0;"><div class="h-sm-400px"></div></div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7 col-md-11 text-center">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="www.sistemasuni.edu.pe" type="button" class="btn btn-dec btn-block" target="blank">Descargar Brochure del Laboratorio</a>
                            </div>
                        </div>
