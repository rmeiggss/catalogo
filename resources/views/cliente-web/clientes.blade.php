                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente1.png" alt=""/>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente2.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente3.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente4.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente5.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente6.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente7.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente8.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom md-no-margin">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente9.png" alt=""/>
                        </div>
                    </div>

                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente10.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente11.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom md-no-margin">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente12.png" alt=""/>
                        </div>
                    </div>

                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente13.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente14.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col-12 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="bg-white clients-list text-center d-flex align-items-center justify-content-center w-100 margin-30px-bottom md-no-margin">
                            <img style="height:190px;width:auto" src="images/catorceavo/cliente15.png" alt=""/>
                        </div>
                    </div>
                    <!-- end client logo item -->
                </div>
