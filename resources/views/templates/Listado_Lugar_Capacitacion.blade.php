...
<body>
<div class="container">
<h1>Listado de Lugares de Capacitacion</h1>
...
<table class="table table-bordered">
	<tr>
		...
		<th class="text-center">Nombre del Lugar de Capacitacion</th>
		<th class="text-center">Descripcion del Lugar de Capacitacion</th>
		<th class="text-center">Acciones</th>
	</tr>
	<tr>
		<td class="text-center">1</td>
		<td class="text-center">Presencial</td>
		<td class="text-center">En la UNI...</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<hr>
		<form class="form-horizontal form-control" style="width:400px;height:330px;margin:0 auto">
		Nombre del Lugar de Capacitacion:
		<br>
		<input class="form-control" type="text" name="" id="primero" />
		Descripcion del Lugar de Capacitacion:
		<br>
