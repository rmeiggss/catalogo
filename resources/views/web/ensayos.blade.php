...
<!--Pagina de contenido-->
    ...
    <div class="row">    
      <div class="col-md-12">
        <h1 style="text-align: center;font-size:65px;">Formulario para Ensayos de Equipos</h1>
        <hr>
      </div>
    </div>
    <div class="row">
      ...
      <div class="row">
          <h2 style="text-align:center;text-decoration: underline;" class="p-3">Equipos que forman parte de la Cotizacion</h2>
          <div class="col-md-12">
            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#mimodalequipo" id="boton_modal">Nuevo Equipo</button>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#mimodalnuevaprueba" id="boton_modal">
                        Nueva Prueba
                        </button>
                    </td>
                    <td class="text-center">
                        <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#mimodallistaprueba" id="boton_modal">
                        Listado de Prueba
                        </button>
                    </td>
                    <td class="text-center">
                ...
                <tr>
                    ...
                    <td class="text-center">www.sieemes.com.pe</td>
                    <td class="text-center">
                        <a class="btn btn-info btn-sm" href="">Nueva Prueba</a>
                    </td>
                    <td class="text-center">
                        <a class="btn btn-dark btn-sm" href="">Listado de Pruebas</a>
                    </td>
                    <td class="text-center">
                        <a class="btn btn-warning btn-sm" href="">Editar</a>
                        <a class="btn btn-danger btn-sm" href="">Eliminar</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<!-- formulario -->
		<div class="container">
		<h1 style="text-align: center">Agregar una Nueva Prueba al Equipo Seleccionado</h1>
		<hr>
...
<div class="modal fade" id="mimodallistaprueba" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<h2 style="text-align: center;text-decoration: underline;">Listado de Pruebas del Equipo Seleccionado</h2>
		<br>
		<!-- formulario -->
		<!-- formulario -->
		<table class="table table-bordered">
