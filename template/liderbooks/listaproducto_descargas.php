  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr bgcolor="#FFF0E1">
        ...
        <th width="152" rowspan="2" align="center" scope="col"><span class="Estilo39">Descargue ya </span></th>
        <th scope="col">&nbsp;</th>
      </tr>
      <tr bgcolor="#FFF0E1">
	...
	if($categoria=="")
	{
	 $cadena="select libro,imagen,titulo,precio,tag_download,download from libro where borrado='' and estado='1' and tag_download='1' " . $filtro;
	}else
	{
	   $cadena="select libro,imagen,titulo,precio,tag_download,download from libro where borrado='' and estado='1' and tag_download='1' and categoria='".$categoria."'" . $filtro;
	}
  ...
  ?>
      ...
      <tr bgcolor="#F5F5F5">
        <td width="85" ><table width="112" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <th width="112" scope="col"><a  href="editarproducto.php?libro=<?php echo $row['libro']?>"><img src="<?=($row['1']=='' ? 'images/no_disponible.jpg':$row['1']);?>" width='85' height='120' border='0'/></a></th>
            </tr>
          </table>
          <a  href="#"></a></td>
        ...
        <td align="center" ><a href="<?=($row['tag_download']=='1' ? $row['download']:'#');?>" target="_blank"><img src="images/descarga.gif" border="0" /></a></td>
        <td >&nbsp;</td>
      </tr>
