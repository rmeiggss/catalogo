...
# ejecutar como ejemplo "mueve_archivos_antiguos_dat.sh /home1/sigma/dat/ 90"
...
cd $1
find . -name "*.*.TXT" -type f -mtime +$2 -exec ls {} \; > salida.txt
find . -name "*.*.TXT.Z" -type f -mtime +$2 -exec ls {} \; >> salida.txt
