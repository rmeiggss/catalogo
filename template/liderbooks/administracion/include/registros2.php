...
<form name="a" method="post">
		<table cellpadding='2' cellspacing='8' border="0" width="100%">
			<tr>
				<td class="titulotabla" style="font:Verdana, Arial, Helvetica, sans-serif; font:bold; font-size:16px" >
					<?=$display;?>
				</td>
			</tr>
		</table>
		<p align='center'>
  <table  bgcolor="#993300" class="tablabotones" border="0" width="95%" cellspacing="0" cellpadding="6">
	  <tr>
					<td class='textobotones' width='80%'>
						...
						<span class="Estilo3">Columna</span> 
		...
		<p align='center'>
  <table style="font:Arial, Helvetica, sans-serif; font-size:12px" bgcolor="#F2F2F2"  class="tabladatos" id="tabla" border='0' width='95%' cellspacing='0' cellpadding='2'>
				<tr>
					<?=$varcabecera;?>
				</tr>
				<?=$vardetalle;?>
