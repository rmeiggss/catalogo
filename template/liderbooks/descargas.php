...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="20%" rowspan="2" align="center" valign="top" bgcolor="#EBEBEB">
      ...
      <tr>
        <td height="29" align="left" valign="top"><? include "busqueda.php";?></td>
      </tr>
	   <tr>
        <td>&nbsp;</td>
      </tr>
	  ...
	  <tr>
        <td valign="top"  bgcolor="#FEF5D8"><? include "categoria.php";?></td>
      </tr>
      <tr>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="104" colspan="2" align="right" valign="top"><?php include "listaproducto_descargas.php"; //=$tabla;?></td>
  </tr>
  <tr>
