...
class Ftp{
	...
	public function abrir(){
		$id_ftp = ftp_connect($this->_server,$this->_port);
		ftp_login($id_ftp,$this->_user,$this->_passwd);
		ftp_pasv($id_ftp,$this->_pasv);
		return $id_ftp;
	}
	...
	public function subir_archivo($fileLocal,$fileRemoto){
		$id_ftp = $this->abrir();
		if(!ftp_put($id_ftp,$fileRemoto,$fileLocal,FTP_BINARY)){
			echo "El archivo tuvo problemas al subir";
		}
		ftp_quit($id_ftp);
	}
}
